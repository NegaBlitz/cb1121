...
public class ConsolePromptUtil {
    ...
    private final String PROMPT_FOR_DATE = "Please specify the date that the customer will check out the tool (use format 'MM/dd/yy'): ";
    private final String WARN_USER_INVALID_TOOLCODE = "Tool code is not recognized; Please insert a valid tool code.";
    private final String WARN_USER_INVALID_DATE = "Date inserted is not in the right format ('MM/dd/yy') or is not a valid date!";
